...
namespace IridiumJS.Native.Array
{
    ...
    {
        private ArrayPrototype(JSEngine engine) : base(engine)
        {
        }

        public static ArrayPrototype CreatePrototypeObject(JSEngine engine, ArrayConstructor arrayConstructor)
        {
