...
namespace IridiumJS.Native.Error
{
    ...
    {
        private ErrorPrototype(JSEngine engine, string name)
            : base(engine, name)
        {
        }

        public static ErrorPrototype CreatePrototypeObject(JSEngine engine, ErrorConstructor errorConstructor, string name)
        {
